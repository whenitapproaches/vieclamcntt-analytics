<template>
	<div class="modal edit-job">
		...
		<div class="modal-content column is-9">
			<div class="box">
				<h1 class="title mb-6">Tạo mới từ khóa</h1>
				...
				<div class="field mt-6">
					<p class="control">
						<base-button class="is-flex ml-auto is-success" @click="createKeywordsButton">Lưu</base-button>
					</p>
				</div>
			</div>
		</div>
